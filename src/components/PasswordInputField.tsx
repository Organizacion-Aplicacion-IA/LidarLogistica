...
import eyeImage from "../assets/images/icons/eye.svg"; // Imagen para el icono 'eye'
import eyeOffImage from "../assets/images/icons/eye-off.svg"; // Imagen para el icono 'eyeOff'
